...
```{r, include = FALSE}
# Injury Data 
injury <- read.csv("/Users/kyokaono/Desktop/subjective/injury/injury.csv")
dim(injury)
```
...
```{r, include = FALSE}
fatigue <- read.csv("/Users/kyokaono/Desktop/subjective/wellness/fatigue.csv")
```
...
```{r, include = FALSE}
mood <- read.csv("/Users/kyokaono/Desktop/subjective/wellness/mood.csv")
```
...
```{r, include = FALSE}
readiness <- read.csv("/Users/kyokaono/Desktop/subjective/wellness/readiness.csv")
```
...
```{r, include = FALSE}
stress <- read.csv("/Users/kyokaono/Desktop/subjective/wellness/stress.csv")
```
...
```{r, include = FALSE}
sleep_duration <- read.csv("/Users/kyokaono/Desktop/subjective/wellness/sleep_duration.csv")
```
...
```{r, include = FALSE}
sleep_quality <- read.csv("/Users/kyokaono/Desktop/subjective/wellness/sleep_quality.csv")
```
...
```{r, include = FALSE}
soreness <- read.csv("/Users/kyokaono/Desktop/subjective/wellness/soreness.csv")
```
...
```{r, include = FALSE}
daily_load <- read.csv("/Users/kyokaono/Desktop/subjective/training-load/daily_load.csv")
```
...
```{r, include = FALSE}
weekly_load <- read.csv("/Users/kyokaono/Desktop/subjective/training-load/weekly_load.csv")
```
...
```{r, include = FALSE}
atl <- read.csv("/Users/kyokaono/Desktop/subjective/training-load/atl.csv")
```
...
```{r, include = FALSE}
ctl28 <- read.csv("/Users/kyokaono/Desktop/subjective/training-load/ctl28.csv")
ctl42 <- read.csv("/Users/kyokaono/Desktop/subjective/training-load/ctl42.csv")
```
...
```{r, include = FALSE}
acwr <- read.csv("/Users/kyokaono/Desktop/subjective/training-load/acwr.csv")
```
...
```{r, include = FALSE}
monotony <- read.csv("/Users/kyokaono/Desktop/subjective/training-load/monotony.csv")
```
...
```{r, include = FALSE}
strain <- read.csv("/Users/kyokaono/Desktop/subjective/training-load/strain.csv")
```
